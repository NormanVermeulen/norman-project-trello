...
export class UserListComponent implements AfterViewInit, OnDestroy {
    displayedColumns: string[] = ['pseudo', 'lastName', 'firstName', 'email', 'birthDate', 'role', 'actions'];
    ...
    ngAfterViewInit(): void {
        ...
        this.dataSource.filterPredicate = (data: User, filter: string) => {
            const str = data.pseudo + ' ' + data.lastName + ' ' + data.firstName + ' ' + data.email + ' ' + data.birthDate + ' ' + data.roleAsString;
